...
ActiveRecord::Schema.define(version: 2020_02_11_032259) do
  ...
  create_table "battles", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["post_id"], name: "index_battles_on_post_id"
  ...
  create_table "seclikes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["battle_id"], name: "index_seclikes_on_battle_id"
  ...
  add_foreign_key "battles", "posts"
  add_foreign_key "battles", "users"
  add_foreign_key "likes", "posts"
  add_foreign_key "likes", "users"
  add_foreign_key "posts", "users"
  add_foreign_key "seclikes", "battles"
